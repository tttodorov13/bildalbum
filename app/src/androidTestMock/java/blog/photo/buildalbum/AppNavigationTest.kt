...
import blog.photo.buildalbum.images.ImagesActivity
import blog.photo.buildalbum.util.DataBindingIdlingResource
import blog.photo.buildalbum.util.EspressoIdlingResource
import blog.photo.buildalbum.util.monitorActivity
...
class AppNavigationTest {
    ...
    fun drawerNavigationFromImagesToStatistics() {
        ...
        onView(withId(R.id.image_nav_view))
    ...
    fun imagesScreen_clickOnAndroidHomeIcon_clickOnCanvasList_OpensCanvassScreen() {
        ...
        onView(withText(R.string.canvas_list)).perform(click())
    ...
    fun imageStatsScreen_clickOnAndroidHomeIcon_OpensNavigation() {
        ...
        activityScenario.onActivity {
            it.findNavController(R.id.images_nav_host_fragment).navigate(R.id.statistics_fragment_dest)
        }
